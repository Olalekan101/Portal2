...
import { GetAuction_Asset } from "../../../../../utils/redux/Assets/AssetSlice";
...
function Auctioning() {
  ...
  const actionButton = (
    <>
      <PermissionCheck permission={DEFINED_PERMISSIONS.AssetAuctionAdd}>
        <CTAButtons onClick={() => navigate("add")}>Add Auction</CTAButtons>
      </PermissionCheck>
    </>
  );
