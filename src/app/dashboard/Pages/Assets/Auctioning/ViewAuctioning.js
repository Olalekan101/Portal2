        ...
        <PageActions>
          {[
            ...
            },
            {
              ...
              permissions: DEFINED_PERMISSIONS.AssetAuctionApprove,
            },
              ...
              <div>
                ...
                <div>
                  ...
                  <h4
                    style={{
                      color:
                        acq?.assetHealthStatus === "Initiated"
                          ? "#815103"
                          : acq?.assetHealthStatus === "Good"
                          ? "#0F6308"
                          : acq?.assetHealthStatus === "Bad"
                          ? "#8A002B"
                          : "",
                    }}
                  >
                    {acq?.assetHealthStatus}
                  </h4>
                </div>
              </div>
            </div>
          ...
          <section className={DashboardStyle.form_section}>
            ...
            <div className={DashboardStyle.labels_group}>
              <div>
                ...
                <div>
                  <p>Opening Date:</p>
                  <h4>{FormatDateTime(acq?.bidOpeningDate, "ll")}</h4>
                </div>
              </div>
              <div>
                <div>
                ...
                <div>
                  <p>Expiry Date:</p>
                  <h4>{FormatDateTime(acq?.bidClosingDate, "ll")}</h4>
                </div>
              </div>
            </div>
          </section>
