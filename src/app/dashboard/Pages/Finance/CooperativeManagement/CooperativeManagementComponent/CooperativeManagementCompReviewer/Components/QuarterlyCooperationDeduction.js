...
let mockData = [
  {
    id: "000",
    cycle: "Tobi Gates y",
    amount: "Information Technology IT",
    start_date: "24 Jan, 2023",
    end_date: "27 Dec, 2024",
  },
  {
    id: "000",
    cycle: "Tobi Gates y",
...
export default function QuarterlyCooperationDeduction() {
  // Filter states
    ...
    <>
      <div className="w-full flex justify-between items-center p-6">
        <div className="flex flex-col justify-start">
          ...
          <div className="flex justify-center items-center bg-[#F8FBF8] p-2 px-4 rounded-lg">
            <GoSearch className="text-xl" />
            <input
              type="search"
              className="p-4 bg-[#F8FBF8] "
              placeholder="search"
            />
          </div>
        </div>
        <button className="p-4 bg-[#F8FBF8] border-2 border-green-400/50 flex justify-center items-center gap-4">
          <HiXMark className="opacity-50" />
          Terminate All
        </button>
      </div>
