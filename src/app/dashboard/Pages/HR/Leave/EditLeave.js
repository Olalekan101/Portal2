...
const AddLeave = () => {
  ...
  const { leave_types, isLoadingLeave } = useSelector((state) => state.hr);
  ...
  const defaultData = {
    ...
    startDate: FormatDateTime(location?.startDate, "YYYY-MM-DD"),
    endDate: FormatDateTime(location?.endDate, "YYYY-MM-DD"),
